...
export const initFilterToggles = () => {
  ...
  document.getElementById('f-rarity').innerHTML = renderFilterToggles('rarity', RARITY, {
    sort: 'desc',
  });
  ...
  document.getElementById('f-tags').innerHTML = renderFilterToggles('tags', CHARA_TAG, {
    attr: function (k) {
      return CHARA_TAG_COLOR[k] ? ' style="color:' + CHARA_TAG_COLOR[k] + '"' : '';
    },
  });
};
...
export const applyFilters = () => {
  ...
  state.filteredChars = FilterCore.applyFilters(
    state.allChars,
    {
      q: q,

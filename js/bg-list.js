...
export const initFilterToggles = () => {
  ...
  // 効果 35 类 / 条件発動 5 类 / 条件対象 5 类 — int enum 复用 renderFilterToggles
  const fe = document.getElementById('f-effect');
  if (fe) fe.innerHTML = renderFilterToggles('effect', PARAMETER_CLASS_LABEL);

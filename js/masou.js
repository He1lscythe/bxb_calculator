...
// Phase 7 Session 3: v2 shape (parameter/math_type/value/effect_text)、不再用 wiki bunrui/scope/condition
      ...
      ${
        ...
        <div>
          ...
          <div style="display:flex;align-items:center;gap:4px">
            ${renderEditSelect({ 0: '×', 1: '+', 2: '×%' }, e.calc_type, `setPath(state.editData,'${ep}.calc_type',+this.value)`)}
